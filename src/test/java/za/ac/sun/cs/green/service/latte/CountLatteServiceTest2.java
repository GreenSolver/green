 ...
 */
public class CountLatteServiceTest2 {
	...
	public void test04a() {
		...
		IntConstant c1 = new IntConstant(1);
		IntConstant cm1 = new IntConstant(-1);
		Operation o = Operation.lt(Operation.add(Operation.mul(c1, a), Operation.mul(cm1, b)), c0);
		check(o, 45);
	}
	...
	public void test05() {
		...
		IntConstant c0 = new IntConstant(0);
		Operation o1 = Operation.gt(x, c0);
		Operation o2 = Operation.gt(y, c0);
		Operation o3 = Operation.gt(z, c0);
		Operation o = Operation.and(o3, Operation.and(o1, o2));
		check(o, 1000);
	}
	...
	public void test05a() {
		...
		IntVariable z = new IntVariable("z", -10, 10);
		IntConstant c0 = new IntConstant(0);
		Operation o1 = Operation.ge(x, c0);
		Operation o2 = Operation.ge(y, c0);
		Operation o3 = Operation.ge(z, c0);
		Operation o = Operation.and(o3, Operation.and(o1, o2));
		check(o, 1331);
	}
