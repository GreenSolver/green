...
public class FactoredConstraintTest {
    ...
    public void test03() {
        ...
        FactorExpression fc3 = new FactorExpression(new Operation(Operation.Operator.AND, fc2.getProcessedExpression(), o3));
    ...
    public void test04() {
        ...
        IntConstant c2 = new IntConstant(4);
        Operation o2 = new Operation(Operation.Operator.EQ, v2, c2);
        FactorExpression fc2 = new FactorExpression(new Operation(Operation.Operator.AND, fc1.getProcessedExpression(), o2));
        assertTrue(fc2.getNumFactors() == 2);
        checkForSubstrings(fc1.getDependentFactor(o1).toString(), "5==v1");
        checkForSubstrings(fc2.getDependentFactor(o2).toString(), "v2==4");
...
/*
    ...
    public void test05() {
        ...
        System.out.println("Factors of "+fc1.getProcessedExpression()+" are:");
...
/*
    ...
    public void test07() {
        ...
        FactorExpression fc1 = new FactorExpression(o1);
        FactorExpression fc2 = new FactorExpression(new Operation(Operation.Operator.AND, fc1.getProcessedExpression(), o234));
