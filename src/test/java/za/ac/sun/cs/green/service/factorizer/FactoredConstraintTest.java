...
public class FactoredConstraintTest {
	...
	public void test01() {
		...
		FactorExpression fc1 = new FactorExpression();
		fc1.factorize(o1);
		assertTrue(fc1.getNumFactors() == 1);
		checkForSubstrings(fc1.getDependentFactor(o1).toString(), "v1==5");
		assertTrue(fc1.getVariableCount() == 1);
		assertTrue(fc1.getDependentConjunctCount() == 1);
	}
	...
	public void test02() {
		...
		FactorExpression fc2 = new FactorExpression();
		fc2.factorize(new Operation(Operation.Operator.AND, o1, o2));
		assertTrue(fc2.getNumFactors() == 2);
		checkForSubstrings(fc1.getDependentFactor(o1).toString(), "v1==5");
		checkForSubstrings(fc2.getDependentFactor(o2).toString(), "v2==4");
		assertTrue(fc2.getVariableCount() == 2);
		assertTrue(fc2.getDependentConjunctCount() == 1);
	}
	...
	public void test03() {
		...
		Operation o2 = new Operation(Operation.Operator.EQ, v2, c2);
		FactorExpression fc2 = new FactorExpression();
		fc2.factorize(new Operation(Operation.Operator.AND, fc1.getProcessedExpression(), o2));
		assertTrue(fc2.getNumFactors() == 2);
		checkForSubstrings(fc1.getDependentFactor(o1).toString(), "5==v1");
		checkForSubstrings(fc2.getDependentFactor(o2).toString(), "v2==4");

		Operation o3 = new Operation(Operation.Operator.EQ, v2, v1);
		FactorExpression fc3 = new FactorExpression(
				new Operation(Operation.Operator.AND, fc2.getProcessedExpression(), o3));
		assertTrue(fc3.getNumFactors() == 1);
		checkForSubstrings(fc3.getDependentFactor(o1).toString(), "5==v1", "v2==4", "v2==v1");
		checkForSubstrings(fc3.getDependentFactor(v1).toString(), "5==v1", "v2==4", "v2==v1");
		checkForSubstrings(fc3.getDependentFactor(o3).toString(), "5==v1", "v2==4", "v2==v1");
		assertTrue(fc3.getVariableCount() == 3);
		assertTrue(fc3.getDependentConjunctCount() == 3);
	}
	...
	public void test04() {
		...
		IntConstant c1 = new IntConstant(5);
		Operation o1 = new Operation(Operation.Operator.EQ, c1, v1);
		FactorExpression fc1 = new FactorExpression(o1);
		assertTrue(fc1.getNumFactors() == 1);
		checkForSubstrings(fc1.getDependentFactor(o1).toString(), "5==v1");
		...
		Operation o2 = new Operation(Operation.Operator.EQ, v2, c2);
		FactorExpression fc2 = new FactorExpression(
				new Operation(Operation.Operator.AND, fc1.getProcessedExpression(), o2));
		assertTrue(fc2.getNumFactors() == 2);
		checkForSubstrings(fc1.getDependentFactor(o1).toString(), "5==v1");
		checkForSubstrings(fc2.getDependentFactor(o2).toString(), "v2==4");
		...
		System.out.println("Factors of " + fc3.getProcessedExpression() + " are:");
	...
	/*
	 * @Test public void test05() { IntVariable v1 = new IntVariable("v1", 0, 100);
	 * IntConstant c1 = new IntConstant(5); Operation o1 = new
	 * Operation(Operation.Operator.EQ, v1, c1); IntVariable v2 = new
	 * IntVariable("v2", 0, 100); IntConstant c2 = new IntConstant(4); Operation o2
	 * = new Operation(Operation.Operator.EQ, v2, c2); Operation o3 = new
	 * Operation(Operation.Operator.AND, o1, o2); Operation o4 = new
	 * Operation(Operation.Operator.AND, v1, v2);
	 * 
	 * FactorExpression fc1 = new FactorExpression(o3);
	 ...
	 * 
	 * System.out.println("Factors of "+fc1.getProcessedExpression()+" are:"); for
	 * (Expression e : fc1.getFactors()) { System.out.println("   "+e); } }
	 */
	@Test
	public void test06() {
		...
		System.out.println("Factors of " + fc2.getProcessedExpression() + " are:");
	 ...
	 * 
	 * FactorExpression fc1 = new FactorExpression(o1); FactorExpression fc2 = new
	 * FactorExpression(new Operation(Operation.Operator.AND,
	 * fc1.getProcessedExpression(), o234));
	 * 
	 * checkForSubstrings(fc2.getDependentFactor(o234).toString(), "v1==v2",
	 * "v2==v3", "v3==v4", "v4==v5");
	 * 
	 * System.out.println("Factors of "+fc2.getProcessedExpression()+" are:"); for
	 * (Expression e : fc2.getFactors()) { System.out.println("   "+e); } }
	 */
}
