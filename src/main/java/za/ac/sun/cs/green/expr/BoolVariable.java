...
public class BoolVariable extends Variable {
	...
	/**
	 * Construct a boolean variable with the given name.
	 * 
	 * @param name new variable name
	 */
	public BoolVariable(final String name) {
		super(name);
	}
	 ...
	 */
	public BoolVariable(final String name, final Object original) {
		super(name);
	}
	...
	public boolean equals(Object object) {
		if (object instanceof BoolVariable) {
			BoolVariable variable = (BoolVariable) object;
