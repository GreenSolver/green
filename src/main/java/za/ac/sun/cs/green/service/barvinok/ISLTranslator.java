 ...
 *
 *               Description: Translator for isl output
 */
public class ISLTranslator {
	...
	/**
	 * Takes a string (in isl format) as input and parse it to Green expressions.
	 * The output is a map of cases to formulas.
	 * 
...
class ISLVisitor extends Visitor {
	...
	ISLVisitor(Stack<Object> stack, ArrayList<IntVariable> vars) {
		this.stack = stack;
		this.vars = vars;
	}
