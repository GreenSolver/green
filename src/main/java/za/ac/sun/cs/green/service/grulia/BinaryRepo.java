...
public abstract class BinaryRepo implements Repo, Comparator<Entry>, Serializable {
	...
	private static final long serialVersionUID = -7135266442729217742L;
	...
	public BinaryRepo(Green solver, boolean defaultZero) {
	...
	/**
	 * Flush all of the repo entries to the Green store (ideally when the store is
	 * Redis or some persistent storage.)
	 */
	@Override
