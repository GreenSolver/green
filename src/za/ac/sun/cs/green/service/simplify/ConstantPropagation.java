			...
			if (nop != null) {
				...
				if ((r instanceof IntVariable) && (l instanceof IntVariable)
					...
					if (variableMap.containsKey(r)) {
						stack.push(new Operation(nop, variableMap.get(r), r));
					}
				} else if ((l instanceof IntVariable) && (r instanceof IntConstant) && (nop != Operation.Operator.EQ)) {
					if (variableMap.containsKey(l)) {
						stack.push(new Operation(nop, variableMap.get(l), r ));
					}
				...
				if (variableMap.containsKey(r)) {
					stack.push(new Operation(op, l, variableMap.get(r)));
				} else if (variableMap.containsKey(l)) {
					stack.push(new Operation(op, variableMap.get(l), r));
				} else {
